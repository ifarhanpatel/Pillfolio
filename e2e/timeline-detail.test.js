describe('Timeline and detail viewer', () => {
  ...
  it('opens the timeline tab', async () => {
    await waitFor(element(by.id('tab-timeline'))).toBeVisible().withTimeout(10000);
    await element(by.id('tab-timeline')).tap();
    await waitFor(element(by.id('timeline-screen'))).toBeVisible().withTimeout(20000);
  ...
  it('filters timeline cards with search input', async () => {
    await waitFor(element(by.id('tab-timeline'))).toBeVisible().withTimeout(10000);
    await element(by.id('tab-timeline')).tap();
    await waitFor(element(by.id('timeline-search-input'))).toBeVisible().withTimeout(15000);
